...
//             </a>
//             <a href="https://twitter.com/tnp_sggsiet">
//               <FontAwesomeIcon className="social-btn" icon={faTwitter} />
//             </a>
//             <a href="https://www.youtube.com/channel/UCxK3BwLWib2jd8y80CbD4DA">
//               <FontAwesomeIcon className="social-btn" icon={faYoutube} />
//             </a>
//             <a href="https://www.linkedin.com/company/placementcell-sggsiet">
//               <FontAwesomeIcon className="social-btn" icon={faLinkedin} />
//             </a>
//             <a href="https://instagram.com/tnp_sggsiet">
